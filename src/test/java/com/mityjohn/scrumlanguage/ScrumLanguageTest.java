...
class ScrumLanguageTest {
    ...
    public static final String HELLO_WORLD_SCRUM = "HelloWorld.scrum";
    public static final String TEXT_INPUT_SCRUM = "TextInput.scrum";
    public static final String ODD_OR_NOT_SCRUM = "OddOrNot.scrum";
    public static final String SEARCH_BACKLOG_SCRUM = "SearchBacklog.scrum";
    ...
    private void runScrumCodeWithInput(String scrumCodeFile, String input, String output) throws URISyntaxException, IOException {
        URL resource = getClass().getClassLoader().getResource(scrumCodeFile);
